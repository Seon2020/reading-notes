...
**What Does Pair Programming Ential?**
...
5. Job Interview Readiness: Pair Programming is often a part of many interview processes, so having practice with it is essential. 
6. Work Environment Readiness: Since Pair Programming is often implemented in the role itself, having practice with it can be a great advantage when just starting! 
